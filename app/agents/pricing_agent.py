"""
Pricing & Package Agent - Provides dynamic pricing recommendations
Workflow: Analyze Market → Get Competitors → Analyze History → Calculate Price → Generate Recommendation

Uses AI to:
- Analyze market rates for similar services
- Compare with competitor pricing
- Consider photographer's history and ratings
- Suggest optimal pricing with reasoning
"""
...
class PricingPackageAgent(BaseAgent):
    """AI agent that analyzes market data and recommends optimal pricing"""
